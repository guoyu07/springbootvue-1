...
public class Reflections {
	...
	/**
	 * 直接读取对象属性的值, 无视private/protected修饰, 不经过getter函数.
	 */
	 ...
	 * 用于�?次�?�调用的情况，否则应使用getAccessibleMethod()函数获得Method后反复调�?.
	 * 同时匹配方法�?+参数类型�?
	 */
	 ...
	 * 用于�?次�?�调用的情况，否则应使用getAccessibleMethodByName()函数获得Method后反复调�?.
	 ...
	 * 匹配函数�?+参数类型�?
	 * 
	 * 用于方法�?要被多次调用的情�?. 先使用本函数先取得Method,然后调用Method.invoke(Object obj, Object... args)
	 */
